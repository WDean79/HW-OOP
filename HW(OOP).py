...
# Выводим характеристики созданных и оцененых студентов
print(f'Перечень студентов:\n\n{student_1}\n\n{student_2}')
print()


# Выводим характеристики созданных и оцененых лекторов
...
def student_rating(student_list, course_name):
    ...
    for i in student_list:
       if i.courses_in_progress == [course_name]:
            sum_all += i.average_rating
            count_all += 1
...
def lecturer_rating(lecturer_list, course_name):
    ...
    for i in lecturer_list:
        if i.courses_attached == [course_name]:
            sum_all += i.average_rating
            count_all += 1
    average_for_all = sum_all / count_all
    return average_for_all
